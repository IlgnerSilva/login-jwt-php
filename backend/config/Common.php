...
include(RelativePath . "/config/Classes.php");
include(RelativePath . "/config/db_adapter.php");
//End Include Files

//Connection Settings @0-6A486D8C
$CCConnectionSettings = array (
    "Connection1" => array(
        "Type" => "MySQL",
        "DBLib" => "MySQL",
        "Database" => "iz1s0wy2mm2vdxz6",
        "Host" => "cxmgkzhk95kfgbq4.cbetxkdyhwsb.us-east-1.rds.amazonaws.com",
        "Port" => "3306;Database=iz1s0wy2mm2vdxz6",
        "User" => "gvjl2f5h2mqp4or1",
        "Password" => "kon1wxqzm81cg9as",
        "Persistent" => false,
...
//Initialize Common Variables @0-ED21D29A
